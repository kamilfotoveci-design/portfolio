const copy={
  cs:{navAria:'Hlavní navigace',topAria:'Kamil Hortík — nahoru',languageAria:'Jazyk',navWork:'Projekty',navContact:'Kontakt',heroLine1:'KAMIL',heroLine2b:'HORTÍK',heroRole:'AI Product Designer & Builder — strategie, UI a kód.',laseroDesc:'AI pracovní prostor pro laserové gravírování. Navrhl a postavil jsem produkt, AI workflow i uživatelské rozhraní.',nacasDesc:'Fakturace pro malé firmy v Česku a na Slovensku. Vytvořil jsem produktový design a kompletní responzivní aplikaci.',subsentryDesc:'Soukromý přehled opakovaných plateb bez připojení banky. Navrhl jsem ho od prvního konceptu po funkční produkt.',openLasero:'Otevřít Lasero',openNacas:'Otevřít Načas',openSubsentry:'Otevřít SubSentry',laseroAlt:'Landing page projektu Lasero',nacasAlt:'Landing page projektu Načas',subsentryAlt:'Landing page projektu SubSentry',contactTitle:'Napište mi.',cursorView:'Otevřít'},
  en:{navAria:'Primary navigation',topAria:'Kamil Hortík — back to top',languageAria:'Language',navWork:'Work',navContact:'Contact',heroLine1:'KAMIL',heroLine2b:'HORTÍK',heroRole:'AI Product Designer & Builder — strategy, UI and code.',laseroDesc:'An AI workspace for laser engraving. I designed and built the product, AI workflow and user interface.',nacasDesc:'Invoicing for small businesses in Czechia and Slovakia. I created the product design and the complete responsive application.',subsentryDesc:'A private overview of recurring payments with no bank connection. I designed it from the initial concept to a working product.',openLasero:'Open Lasero',openNacas:'Open Načas',openSubsentry:'Open SubSentry',laseroAlt:'Lasero project landing page',nacasAlt:'Načas project landing page',subsentryAlt:'SubSentry project landing page',contactTitle:'Get in touch.',cursorView:'View'}
};
